...
const MarginStatusBar = (props: TouchableProps) => (
  <Touchable {...props} height={statusBarHeight} />
);
...
const _31 = (props: TouchableProps) => (
  <Touchable {...props} height={pixel(31)} />
);
